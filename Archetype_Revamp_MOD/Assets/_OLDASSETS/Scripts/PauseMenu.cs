...
/*namespace Archetype.AGameSettings.AGamePaused {}
	...
	public class PauseMenu : MonoBehaviour
	{
		...
		void Update() {
			Debug.Log ((GamePaused.GameIsPaused ? "Game is paused" : "Game is not paused"));
		}
